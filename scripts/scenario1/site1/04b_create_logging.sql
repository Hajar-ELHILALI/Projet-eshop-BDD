-- ============================================================
-- SITE 1 — Journalisation des erreurs de synchronisation
-- Remplace les "WHEN OTHERS THEN NULL" qui masquaient les échecs :
-- desormais toute erreur de propagation est TRACÉE (sans bloquer
-- l'opération locale), et consultable dans la table SYNC_ERRORS.
-- ============================================================
...
CREATE OR REPLACE PROCEDURE log_sync_error(
    ...
    -- Transaction autonome : l'erreur est conservée même si la
